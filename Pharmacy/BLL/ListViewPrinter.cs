...
namespace BrightIdeasSoftware
{
    ...
    class ListViewPrinterBase : PrintDocument
    {
        ...
        public ListViewPrinterBase()
        {
            ...
            this.ListHeaderFormat = BlockFormat.ListHeader(12,Brushes.LightGray,true);
            this.ListHeaderStringFormat = BlockFormat.ListHeader(24,Brushes.White, false);
       ...
       Description("Should listview headings be printed at the top of each page, or just at the top of the list?"),
        ...
        public BlockFormat ListHeaderStringFormat
        {
            get { return listHeaderStringFormat; }
            set { listHeaderStringFormat = value; }
        }
        public BlockFormat listHeaderStringFormat;
        ...
        protected bool PrintOnePage(PrintPageEventArgs e)
        {
            ...
            bool continuePrinting = this.PrintList(e.Graphics, this.ListView);// "BÁO CÁO CÔNG NỢ");
        ...
        protected bool PrintList(Graphics g, ListView lv)
        {
            ...
            if (this.rowIndex == 0 || this.IsListHeaderOnEachPage)
                this.PrintListHeader(g, lv,Tieude);
        ...
        /// <param name="g">The graphic used for drawing</param>
        /// <param name="lv">The listview to be printed</param>
        protected void PrintListHeader(Graphics g, ListView lv, string Title)
        {
            DrawTitle(g,Title);
        ...
        public void DrawTitle(Graphics g,string Title)
        {
            ...
            BlockFormat fmtStr = this.ListHeaderStringFormat;
    ...
    class ListViewPrinter : ListViewPrinterBase
    {
        ...
        public ListViewPrinter(string strTitle)
        {
            Tieude = strTitle;
        }
    ...
    class BlockFormat : System.ComponentModel.Component
    {
        ...
        static public BlockFormat DefaultCell()
        {
            ...
            fmt.SetBorderPen(Sides.All, new Pen(Color.BurlyWood, 0.5f));
        ...
        /// </summary>
        static public BlockFormat ListHeader(int siseFont, Brush b, bool isBorder)
        {
            return BlockFormat.ListHeader(new Font("Verdana", siseFont), b, isBorder);
        }
        static public BlockFormat ListHeader(Font f, Brush brush, bool isBorder)
        {
            BlockFormat fmt = new BlockFormat();

            fmt.Font = f;
            fmt.TextBrush = Brushes.Black;
            fmt.BackgroundBrush = brush;
            if(isBorder)
        ...
        static public BlockFormat GroupHeader(Font f)
        {
            ...
            fmt.SetBorder(Sides.Bottom, 3f, new LinearGradientBrush(new Point(1, 1), new Point(2, 2), Color.Brown, Color.White));
            fmt.SetTextInset(Sides.All, 1.0f);
