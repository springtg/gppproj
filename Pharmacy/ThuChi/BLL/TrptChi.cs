    ...
    class TrptChi
    {
        ...
        public TrptChi() {
            DataColumn[] dc = new DataColumn[]{ 
                               new DataColumn("TenNCC", Type.GetType("System.String")),
                               ...
                               new DataColumn("NgayChi", Type.GetType("System.String")),
        ...
        {
            DataSet data = connect.GetDataSetByStoredProcedure("usp_rptPHIEUCHI",
               new string[] { "@Ma" },
               new object[] { ma }
                );
            return data;
        ...
        public DataTable SetData(int ma)
        {
            ...
            dataSQL = GetNhap(ma);
                ...
                if (dataSQL.Tables[1].Rows[i]["MaNCC"].ToString() == "0")
                {
                ...
                {
                    r["TenNCC"] = dataSQL.Tables[1].Rows[i]["Ten"].ToString();
                ...
                r["NgayChi"] = GetDateFormat(dataSQL.Tables[1].Rows[i]["NgayChi"].ToString());
